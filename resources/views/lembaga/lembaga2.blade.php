...
@section('title', 'Lembaga Amil Zakat Infaq dan Shadaqah Muhammadiyah PDM Kota Kuansing')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-12 text-center">
                    <div class="page-banner-content">
                        <h1 class="display-4 font-weight-bold">Lembaga Amil Zakat Infaq dan Shadaqah Muhammadiyah PDM Kota
                            Semarang</h1>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-10 col-md-12 text-center">
                    <h2 class="mb-4 font-weight-bold">Susunan Pimpinan Lembaga</h2>
                    <div class="divider mb-4" style="width: 100px; height: 3px; background-color: #3498db; margin: 0 auto;">
                    </div>
                    <p class="lead">
                        Mengenal para pemimpin yang membentuk visi dan masa depan Lembaga Amil Zakat Infaq dan Shadaqah
                        Muhammadiyah PDM Kota Semarang.
                    </p>
                </div>
            </div>
